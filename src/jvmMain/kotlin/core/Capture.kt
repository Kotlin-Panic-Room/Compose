...
object Capture {
    ...
    fun getScreenShot(handle: WinDef.HWND, tlX: Int = 0, tlY: Int = 0, width: Int = 0, height: Int = 0): Mat {
        var width = width
        var height = height
        ...
        buffer.read(0, pixels, 0, bufferSize)
//        System.arraycopy(buffer, 0, pixels, 0, bufferSize)
        ...
        return ImageProcessor.convertBufferedImageToMat(image)
    }
}
